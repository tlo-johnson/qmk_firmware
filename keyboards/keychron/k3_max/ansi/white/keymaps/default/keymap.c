...
[MAC_BASE] = LAYOUT_ansi_84(
     ...
     LT(1, KC_ESC),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
...
[MAC_FN] = LAYOUT_ansi_84(
     ...
     BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  _______,  _______,  S(KC_9),  _______,  _______,  S(KC_0),   _______,  _______,  _______,            _______,
     _______,  _______,  BL_DOWN,  _______,  _______,  _______,  S(KC_MINS),  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,  S(KC_EQL),            _______,            _______,
     _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  KC_MINS,  _______,  _______,   KC_EQL,            _______,  _______,  _______,
